...
/**
 * Represents a group of {@link Component}s. It is used to describe what {@link com.badlogicmods.ashley.core.Entity} objects an {@link EntitySystem} should
...
public class Family {
	...
	public static Family getFor (Class<? extends Component>... componentTypes) {
		return getFor(com.badlogicmods.ashley.core.ComponentType.getBitsFor(componentTypes), zeroBits, zeroBits);
	}
	 ...
	 * @param all entities will have to contain all of the components in the set. See {@link com.badlogicmods.ashley.core.ComponentType#getBitsFor(Class<?
	 *           extends Component> ...)}.
	 * @param one entities will have to contain at least one of the components in the set.See {@link
	 *           com.badlogicmods.ashley.core.ComponentType#getBitsFor(Class<? extends Component> ...)}.
	 * @param exclude entities cannot contain any of the components in the set. See {@link com.badlogicmods.ashley.core.ComponentType#getBitsFor(Class<? extends
	 *           Component> ...)}.
	 * @return The family
	 * @deprecated Use builder functionality instead ({@link Family#all}, {@link Family#one}, {@link Family#exclude})
	 */
	...
	public static class Builder {
		...
		public final Builder all ( Class< ? extends Component>... componentTypes) {
			all = com.badlogicmods.ashley.core.ComponentType.getBitsFor(componentTypes);
			return this;
		}
		...
		public final Builder one ( Class< ? extends Component>... componentTypes) {
			one = com.badlogicmods.ashley.core.ComponentType.getBitsFor(componentTypes);
			return this;
		}
	...
	private static String getFamilyHash (Bits all, Bits one, Bits exclude) {
		...
		if (result == null) { throw new NullPointerException("Family's builder toString returned null."); }
		return result;
	}
