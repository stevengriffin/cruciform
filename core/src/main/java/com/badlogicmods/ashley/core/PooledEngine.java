...
/**
 * Supports {@link com.badlogicmods.ashley.core.Entity} and {@link com.badlogicmods.ashley.core.Component} pooling. This improves performance in environments where creating/deleting
...
public class PooledEngine extends com.badlogicmods.ashley.core.Engine {
	...
	/** @return Clean {@link com.badlogicmods.ashley.core.Entity} from the Engine pool. In order to add it to the {@link com.badlogicmods.ashley.core.Engine}, use {@link #addEntity(com.badlogicmods.ashley.core.Entity)}. */
	public com.badlogicmods.ashley.core.Entity createEntity () {
		return entityPool.obtain();
	}

	/**
	 * Retrieves a new {@link com.badlogicmods.ashley.core.Component} from the {@link Engine} pool. It will be placed back in the pool whenever it's removed
	 * from an {@link com.badlogicmods.ashley.core.Entity} or the {@link com.badlogicmods.ashley.core.Entity} itself it's removed.
	 */
	public <T extends com.badlogicmods.ashley.core.Component> T createComponent (Class<T> componentType) {
	...
	private class PooledEntity extends Entity implements Poolable {
		@Override
		@Nullable
        com.badlogicmods.ashley.core.Component removeInternal (Class<? extends com.badlogicmods.ashley.core.Component> componentType) {
