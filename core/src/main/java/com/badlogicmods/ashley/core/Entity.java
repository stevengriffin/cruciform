...
import com.badlogicmods.ashley.utils.Bag;
...
public class Entity {
	...
	public final com.badlogicmods.ashley.signals.Signal<Entity> componentAdded;
	/** Will dispatch an event when a component is removed. */
	public final com.badlogicmods.ashley.signals.Signal<Entity> componentRemoved;

	long uuid;
	boolean scheduledForRemoval;
	Engine.ComponentOperationHandler componentOperationHandler;

	private com.badlogicmods.ashley.utils.Bag<Component> components;
	private Array<Component> componentsArray;
	private com.badlogicmods.ashley.utils.ImmutableArray<Component> immutableComponentsArray;
	...
	public Entity () {
		...
		immutableComponentsArray = new com.badlogicmods.ashley.utils.ImmutableArray<Component>(componentsArray);
		componentBits = new Bits();
		familyBits = new Bits();
		flags = 0;

		componentAdded = new com.badlogicmods.ashley.signals.Signal<Entity>();
	 ...
	 */
	public @NotNull Entity add (@NotNull Component component) {
	...
	public Component remove (Class<? extends Component> componentClass) {
		com.badlogicmods.ashley.core.ComponentType componentType = com.badlogicmods.ashley.core.ComponentType.getFor(componentClass);
	...
	public <T extends Component> T getComponent (Class<T> componentClass) {
		return getComponent(com.badlogicmods.ashley.core.ComponentType.getFor(componentClass));
	}
	...
	@Nullable
	<T extends Component> T getComponent (com.badlogicmods.ashley.core.ComponentType componentType) {
	 ...
	 */
	boolean hasComponent (com.badlogicmods.ashley.core.ComponentType componentType) {
	...
	Entity addInternal (Component component) {
		...
		int componentTypeIndex = com.badlogicmods.ashley.core.ComponentType.getIndexFor(component.getClass());
	...
	Component removeInternal (Class<? extends Component> componentClass) {
		com.badlogicmods.ashley.core.ComponentType componentType = ComponentType.getFor(componentClass);
		int componentTypeIndex = componentType.getIndex();
		Component removeComponent = components.get(componentTypeIndex);
