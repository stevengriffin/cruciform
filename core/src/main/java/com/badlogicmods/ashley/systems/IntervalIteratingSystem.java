...
/**
 * A simple {@link EntitySystem} that processes a {@link com.badlogicmods.ashley.core.Family} of entities not once per frame, but after a given interval.
 * Entity processing logic should be placed in {@link IntervalIteratingSystem#processEntity(com.badlogicmods.ashley.core.Entity)}.
...
public abstract class IntervalIteratingSystem extends IntervalSystem {
	...
	private com.badlogicmods.ashley.utils.ImmutableArray<com.badlogicmods.ashley.core.Entity> entities;
	 ...
	 */
	public IntervalIteratingSystem (com.badlogicmods.ashley.core.Family family, float interval) {
	...
	public IntervalIteratingSystem (Family family, float interval, int priority) {
		...
		this.family = family;
		this.entities = new com.badlogicmods.ashley.utils.ImmutableArray<com.badlogicmods.ashley.core.Entity>();
	}
