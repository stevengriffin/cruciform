...
/**
 * A simple {@link com.badlogicmods.ashley.core.EntitySystem} that does not run its update logic every call to {@link com.badlogicmods.ashley.core.EntitySystem#update(float)}, but after a
