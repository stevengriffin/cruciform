...
public class Engine {
	...
	static class ComponentOperationHandler {
		...
		public void add (@NotNull Entity entity, @NotNull Component component) {
			if (engine.updating) {
		...
		public void remove (@NotNull Entity entity, Class<? extends Component> componentClass) {
			if (engine.updating) {
				ComponentOperation operation = engine.componentOperationsPool.obtain();
	...
	private static class ComponentOperation {
		...
		public void makeRemove (@NotNull Entity entity, Class<? extends Component> componentClass) {
